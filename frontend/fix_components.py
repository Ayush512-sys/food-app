...
live_attendance_replacement = r"""// ─── LIVE ATTENDANCE & QR SCANNER ──────────────────────────────────────────────
...
student_management_replacement = r"""// ─── STUDENT MANAGEMENT ────────────────────────────────────────────────────────
...
new_content = content[:s1] + live_attendance_replacement + "\n\n" + content[e1:s2] + student_management_replacement + "\n\n" + content[e2:]
